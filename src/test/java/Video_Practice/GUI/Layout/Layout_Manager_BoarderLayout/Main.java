package Video_Practice.GUI.Layout.Layout_Manager_BoarderLayout;
...
public class Main {
    public static void main(String[] args) {
        ...
        // BorderLayout = A BorderLayout places components in five areas: NORTH,SOUTH,WEST,EAST,CENTUR
